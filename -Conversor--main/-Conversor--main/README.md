<h1 align="center"> Challenge ONE Practicando Java 1: Crea tu propio conversor de moneda </h1>

 

## Descripción del Proyecto
Este Challenge  forma parte del proyecto ONE – Oracle Next Education con alula Latam, con esta formación se dio el conocimiento para desarrollar  este challenge por medio de  una serie de sprints y  un tablero de trello para organizar el trabajo
Este Challence consiste en crear un conversor de divisas/monedas utilizando el lenguaje Java.
